...
export const workCards: WorkCard[] = [
  {
    title: "Helium - engineering assistant",
    subtitle: "AI-powered engineering assistant",
    description:
      "Helium is an AI-powered engineering assistant that helps you debug, write",
    href: "https://app.bio.xyz",
  ...
  },
  {
    ...
    description:
      "Maximize returns using our cutting-edge DeFi strategies and tools.",
  ...
  },
  {
    ...
    description:
      "JuicyPerp is your hub for gamified options trading on meme coins and exotic digital assets.",
  ...
  },
  {
    ...
    description:
      "Y2K Finance offers structured products for hedging or speculating on the risk of pegged assets.",
  ...
  },
  {
    ...
    description:
      "Bluey telegram bot enable users to trade tokens on sui network and place orders.",

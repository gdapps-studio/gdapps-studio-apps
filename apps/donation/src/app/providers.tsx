...
import PaymentCardHeader from "./_components/payment-card-header";
...
export const Providers = ({ children }: { children: ReactNode }) => {
  ...
  const [selectedChain, setSelectedChain] = useState<ChainUnion>(
    "ethereum" as ChainUnion
  );
        ...
        <WalletModalProvider>
          <WagmiProvider config={config}>
            <QueryClientProvider client={queryClient}>
              ...
              >
                <PaymentCardHeader chain={selectedChain} />

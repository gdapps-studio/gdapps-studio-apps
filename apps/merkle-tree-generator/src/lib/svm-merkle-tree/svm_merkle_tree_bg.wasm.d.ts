...
export function merkletree_merkle_proof_hash(
    a: number,
    b: number,
    c: number,
    d: number
): void
export function merkletree_merkle_proof_index(
    a: number,
    b: number,
    c: number
): void
export function merkleproof_new(
    a: number,
    b: number,
    c: number,
    d: number,
...
export function merkleproof_merklize(
    a: number,
    b: number,
    c: number,
    d: number
): void
export function merkleproof_merklize_hash(
    a: number,
    b: number,
    c: number,
    d: number
